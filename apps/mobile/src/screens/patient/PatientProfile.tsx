...
import { ChevronRight, User, Settings, Shield, HelpCircle, LogOut } from 'lucide-react-native';
    ...
    <SafeAreaView className="flex-1 bg-slate-50" edges={['top']}>
      <ScrollView className="flex-1">
        <View className="items-center py-8 bg-white border-b border-slate-200">
          ...
          <View className="mt-4 bg-indigo-50 px-4 py-1.5 rounded-full">
            <Text className="text-indigo-600 font-medium">Patient</Text>
          </View>
        </View>
        ...
        <View className="mt-6 px-4">
          <View className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm shadow-slate-100 elevation-1">
            ...
            <ProfileOption icon={<Settings size={20} color={tokens.colors.primary.DEFAULT} />} title="Preferences" />
            <ProfileOption icon={<HelpCircle size={20} color={tokens.colors.primary.DEFAULT} />} title="Help & Support" isLast />
          </View>
